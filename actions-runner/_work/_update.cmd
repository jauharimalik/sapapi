...
set rootfolder=C:\laragon\www\sapapi\actions-runner
set existrunnerversion=2.327.1
set downloadrunnerversion=2.328.0
set logfile=C:\laragon\www\sapapi\actions-runner\_diag\SelfUpdate-20250816-034948.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "C:\laragon\www\sapapi\actions-runner\run.cmd"
) else (
  endlocal
)
